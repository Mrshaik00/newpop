...
<body>
    ...
    <section class="revcolor">
        <section class="reviews">
            ...
            <div class="stud">
                <div class="r1" id="r2">
                    <img src="user1.jpg">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. sit amet consectetur adipisicing elit. Harum veniam nobis mollitia.</p>
                    <h1>lina Lease </h1>
                ...
                <div class="r1">
                    <img src="user2.jpg">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing sit amet consectetur, adipisicing elit. Hic doloribus numquam voluptatibus?
                    </p>
                    <h1>stuward</h1>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
    ...
    <section class="endgame">
        ...
        <a href="contact.php" class="button" id="btnn" style="vertical-align:middle;"><span>contact now</span></a>
